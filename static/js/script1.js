document.addEventListener('DOMContentLoaded', function() {
    ...
    function setInitialTheme() {
        ...
        const gmt530 = new Date(utc + (5.5 * 3600000));
        const hours = gmt530.getHours();
        
        // Day mode from 6AM to 6PM GMT+5:30
        const isDayTime = hours >= 6 && hours < 18;
        
        document.body.classList.toggle('light-mode', isDayTime);
        document.body.classList.toggle('dark-mode', !isDayTime);
        themeIcon.className = isDayTime ? 'fas fa-moon' : 'fas fa-sun';
        
        // Save preference
        localStorage.setItem('preferredTheme', isDayTime ? 'light' : 'dark');
    }
    ...
    themeToggle.addEventListener('click', function() {
        ...
        // Save preference
        localStorage.setItem('preferredTheme', isLightMode ? 'dark' : 'light');
